      ...
      max-[960px]:w-[90%] gap-10 mt-5  max-[560px]:grid-cols-1 max-[560px]:w-[80%] mb-10 rounded-lg  "
        >
          {info.portfolio.map((item, index) => (
            <div key={index}>
              <BackgroundGradient className="shadow-xl rounded-3xl  bg-base-100  md:w-[70%] lg:w-full md:mx-auto hero">
                <div className="flex-col hero-content lg:flex-row-reverse">
                  ...
                  <div className="card card-compact scroll-smooth lg:card-side">
                    <div className=" card-body">
                      <h2 className="flex justify-center mt-4 card-title bg-[linear-gradient(90deg,#fffb00,#ff0055,#0ef)] bg-clip-text text-transparent">
                        {item?.title}
                      </h2>
                      ...
                      <div className="flex flex-wrap justify-center gap-2 mt-4">
                        {item.icons.map((tech, index) => (
                          ...
                          >
                            <span
                              className="text-2xl duration-300 tooltip hover:scale-105"
                              data-tip={tech?.name}
                            >
                              {tech?.icon}
                            </span>
